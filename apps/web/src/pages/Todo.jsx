  ...
  return (
    ...
    <div style={pageForm}>
      ...
      <Werkzeugleiste style={{ marginBottom: 16 }}>
        <input data-tour="todo-neu" value={text} onChange={(e) => setText(e.target.value)} onKeyDown={(e) => { if (e.key === "Enter") add(); }} placeholder={t("todo.placeholder")} style={{ ...toolbarInput, flex: 20, minWidth: 160 }} />
