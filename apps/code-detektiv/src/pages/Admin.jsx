                  ...
                  <div key={session.id} style={{ background: '#fff', borderRadius: 8, border: '1px solid #e0e0e0', padding: 20 }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
                      ...
                      <div style={{ display: 'flex', gap: 8 }}>
                        ...
                        <button className="btn btn-primary" onClick={() => navigate(`/play/${session.id}`)}>
                          Ansehen
                        </button>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24, alignItems: 'start' }}>
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              {state.puzzles.map(puzzle => (
                <div key={puzzle.id} className="puzzle-card" onClick={() => navigate(`/puzzle/${puzzle.id}?mode=solo`)}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
                      <button className="btn btn-outline"
                        onClick={e => { e.stopPropagation(); navigate(`/puzzle/${puzzle.id}?mode=solo`); }}
