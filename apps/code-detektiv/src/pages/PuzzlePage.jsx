            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              ...
              <div className="solution-area">
                ...
                <div style={{ display: 'flex', gap: 8, marginTop: 16, flexWrap: 'wrap' }}>
                  ...
                  {solved && isSolo && (
                    <button className="btn btn-primary" onClick={() => navigate('/solo')}>Nächstes Rätsel →</button>
                  )}
                  {solved && sessionId && (
                    <button className="btn btn-primary" onClick={() => navigate(`/play/${sessionId}`)}>Zurück zur Session →</button>
                  )}
