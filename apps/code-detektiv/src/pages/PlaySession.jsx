    ...
    return (
      <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#f5f5f5' }}>
        <div style={{ textAlign: 'center', maxWidth: 400 }}>
          ...
          <button className="btn btn-primary" onClick={() => navigate('/')}><IconBack size={14} /> Zurück zur Startseite</button>
        </div>
      </div>
    );
  }
      ...
      <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#f5f5f5' }}>
        <div style={{ textAlign: 'center', maxWidth: 400 }}>
          ...
          <button
            ...
            onClick={() => navigate(`/puzzle/${currentPuzzleId}?session=${sessionId}`)}
          >
