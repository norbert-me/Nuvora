...
| Kalender | `/kalender` | Tag/Woche/Monat + wiederkehrender Stundenplan; Stoffverteilungsplan je Kurs (Soll-/Ist-Stunden, Zeitraum gerechnet statt eingetragen); Quiz, Deck oder Lernleiter an eine Stunde planen; Klassenarbeitstermine mit ihren Themen; freie Tage; ICS-Feed raus, externer Kalender read-only rein (SSRF-gehärtet); **Stundenplan aus WebUntis übernehmen** (API oder Abo-Link, mit Zuordnung je Stunde, nie zurückschreiben); **CalDAV** — Termine aus Apple/Outlook anlegen und ändern, mit Geräte-Passwörtern |
