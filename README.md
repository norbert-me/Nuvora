...
| Karteikarten | `/karten` | Spaced Repetition (SM-2). Alle Stapel liegen in **einer Sammlung** (Ordner) und werden **einem oder mehreren Kursen zugewiesen** — die Klassenauswahl ist nur noch ein Filter. Lernende üben **ohne Konto** per QR-Code; Reifegrad sichtbar, Meisterung als Notenspalte übernehmbar. E/G am Stapel **und** an der einzelnen Karte; arbeitet der Kurs mit E/G, ist eine **neue** Karte G, bis sie auf E geschaltet wird |
